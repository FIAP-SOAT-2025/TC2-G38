...
import { PaymentTypeEnum } from "src/payments/domain/model/payment.entity";
import PaymentProviderRepository from "src/payments/domain/repository/payment-provider.repository";

@Injectable()
export class MercadoPagoClient implements PaymentProviderRepository {
  constructor(
